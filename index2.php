...
<section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
        ...
        <h2>Menyeleksi Calon Komandan Kodim 0201/BS Medan</h2>
        ...
        <div class="container">
            ...
            <div class="row content">
                <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                    <h2>Tentang </h2>
                    <h3>Sistem Pendukung Keputusan Menyelesi Calon Komandan Kodim 0201/BS Medan</h3>
                    <h6>Sistem ini di rancang untuk memudahkan tim penilai Kodim 0201/BS Medan dalam pemilihan Komandan
                        Kodim 0201/BS Medan.
                        Terdapat 22 Kriteria untuk dapat menjadi Komandan Kodim 0201/BS Medan

                    </h6>
                </div>
                <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
                    <h3>Sejarah KODIM 0201/BS</h3>
                    <p>Kodim 0201/BS beralamat di Jl. Pengadilan No 8 Kelurahan Petisah Tengah, Kecamatan Medan
                        Petisah Kota Medan Provinsi Sumatera Utara

                    </p>
                    <p>
                        Sejarah terbentuknya Kodim 0201/BS tidak terlepas dari proses terbentuknya Kodam I/Bukit Barisan
                        yang merupakan pertumbuhan penyusunan kembali organisasi TNI AD terutama mengenai Kodam, jumlah
                        Kodam dikurangi dari 16 menjadi 10. Setelah tenjadinya pengungkapkan pernyataan dari pemerintah
                        Belanda kepada Pemerintah RI, maka seluruh kekuatan bersenjata yang berada di Sumatera Utara
                        dihimpun menjadi Komando Tentara Teritorium Sumatera Utara (Ko T.T/SU). Peristiwa ini terjadi
                        pada tahun 1950
                    </p>
    ...
    <section id="cta" class="cta">
        <div class="container">
            ...
            <div class="text-center" data-aos="zoom-in">
                <h3>Kodim 0201/BS</h3>
                <p> Komando Distrik Militer (disingkat Kodim) adalah komando pembinaan dan operasional kewilayahan TNI
                    Angkatan Darat di bawah Korem</p>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="section-title" data-aos="fade-right">
                        ...
                        <p>komando pembinaan dan operasional kewilayahan TNI Angkatan Darat di bawah Korem. Kodim
                            membawahi beberapa Komando Rayon Militer (Koramil)</p>
                ...
                <div class="col-lg-8 d-flex align-items-stretch mt-lg-0">
                    <div class="icon-box" data-aos="zoom-in" data-aos-delay="200">
                        ...
                        <p>Kodim 0201/BS terdiri dari 21 Kecamatan Kota Medan dan 8 Kecamatan Kabupaten Deli Serdang
                            dengan membawahi 16 Koramil </p>
                        <table class="table table-success table-striped">
                            <thead>
                                <tr>
                                    <th scope="col">No</th>
            ...
            <div class="row">
                ...
                <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="info mt-4">
                        ...
                        <h4>Location:</h4>
                        <p>Jl. Pengadilan No 8 Kelurahan Petisah Tengah, Kecamatan Medan Petisah Kota Medan Provinsi
                            Sumatera Utara</p>
                    </div>
                    <div class="row">
