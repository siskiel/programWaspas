...
<a href="index.php?halaman=kriteria" class=" btn btn-warning  pull-right" > << Kembali </a>
<br>
<br>
<?php
...
<div class="form-group">
        <label>Kode Kriteria</label>
            <input type="text" class="form-control" name="kode" value="<?php echo $pecah['kode_kriteria'];?>" readonly>
    </div>
    <div class="form-group">
