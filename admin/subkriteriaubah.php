...
?>
        <form method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama_sub" value="<?php echo $pecah['nama_sub'];?>">
            </div>
            <div class="form-group">
                <label>Bobot Sub Kriteria</label>
                <input type="number" class="form-control" name="bobot_sub" value="<?php echo $pecah['bobot_sub'];?>">
            </div>
...
if(isset($_POST['ubah']))
{
        ...
        bobot_sub='$_POST[bobot_sub]' WHERE id_sub_kriteria='$_GET[id]'");
