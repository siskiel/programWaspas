        ...
        <div class="container">
            <form method="Post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="pangkat" class="form-control" id="pangkat"
                            value="<?php echo $pecah['pangkat']; ?>" data-rule="minlen:4"
                            data-msg="Please enter at least 4 chars" required />
                        <div class="validate"></div>
                    </div>
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" class="form-control" name="jabatan" id="jabatan"
                            value="<?php echo $pecah['jabatan']; ?>" data-rule="minlen:4"
                            data-msg="Please enter a valid email" required />
                        <div class="validate"></div>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="kesatuan" class="form-control" id="kesatuan"
                            value="<?php echo $pecah['kesatuan']; ?>" data-rule="minlen:4"
                            data-msg="Please enter at least 4 chars" required />
                        <div class="validate"></div>
                    </div>
                    <div class="col-md-6 form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" name="blangko" id="blangko" data-rule=".pdf"
                        value="<?php echo $pecah['blangko']; ?>" required />
