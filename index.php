        ...
        <div id="carouselOne" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item bg_cover active"
                    style="background-image: url(assets/index/assets/images/51.png)">
                ...
                <div class="carousel-item bg_cover" style="background-image: url(assets/index/assets/images/41.png)">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-xl-6 col-lg-7 col-sm-10">
                                    <h2 class="carousel-title">Sistem Pakar Pendukung Keputusan
                                        Menentukan Calon
                                        Pelatih PSMS Medan</h2>
                                    <ul class="carousel-btn rounded-buttons">
                                        <li><a class="main-btn rounded-three" href="#">Daftar</a>
                ...
                <div class="carousel-item bg_cover" style="background-image: url(assets/index/assets/images/31.png)">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-xl-6 col-lg-7 col-sm-10">
